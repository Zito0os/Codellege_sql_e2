...
import './App.css'
import { getAttendance, getDashboard, getServices } from './api/dashboardApi'
import AttendanceView from './components/attendance/AttendanceView'
import DashboardOverview from './components/dashboard/DashboardOverview'
import Sidebar from './components/layout/Sidebar'
import ServicesView from './components/services/ServicesView'

const initialData = { dashboard: null, attendance: { employees: [], departments: [] }, services: [] }
...
function App() {
    ...
    useEffect(() => {
        Promise.all([getDashboard(), getAttendance(), getServices()])
            .then(([dashboard, attendance, services]) => setData({ dashboard, attendance, services: services.services || [] }))
